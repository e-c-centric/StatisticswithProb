...
ggplot(myHealthData, aes(x = myHealthData$Orientation, y = myHealthData$Education, fill = myHealthData$Gender),col="blue") +  geom_boxplot() +   facet_grid(. ~ droplevels.factor(myHealthData$Gender))
